""" ABGame: This gives the next White move for a Mid/End game using Alpha-Beta Pruning"""
...
def ABGame(L, depth:int, alpha, beta, MaximizingPlayer:bool, ct):
    ...
    if MaximizingPlayer=="W":
        ...
        n = l2[0]
        for child in l2:
            eva, c, new_n = ABGame(child, depth - 1,alpha,beta, "B", ct)
            ct=c
            if eva > maxEva:
                n = child
                maxEva = eva
        ...
        n = l3[0]
        for child in l3:
            eva,c,q= ABGame(child, depth - 1,alpha,beta,"W",ct)
            ct=c
            if eva<minEva:
                n=child
                minEva=eva
...
if __name__ == "__main__":
    ...
    # file_location2 = "/Users/monik/PycharmProjects/AI_Project/output4.txt"
    ...
    beta = math.inf
    print("AB Game:")
    a,b,c = ABGame(L, depth,alpha,beta, "W", 0)
