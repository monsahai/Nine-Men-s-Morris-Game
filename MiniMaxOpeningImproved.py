""" MiniMaxOpening: This gives the next White move for a Opening game using MiniMax"""
...
def staticEstimate(L:list,ct):
    ...
    for i in range(len(L)):
        if L[i]=="W":
            if closeMill(i,L):
                count+=1
    return (numWhite-numBlack+count,ct)
...
if __name__ == "__main__":
    ...
    # file_location2 = "/Users/monik/PycharmProjects/AI_Project/output7.txt"
