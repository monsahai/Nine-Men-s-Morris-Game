""" MiniMaxGameBlack: This gives the next Black move for a Mid/End game using MiniMax"""
...
if __name__ == "__main__":
    ...
    # file_location2 = "/Users/monik/PycharmProjects/AI_Project/output6.txt"
    ...
    print("Mid/End Game:")
    a,b,c = MiniMaxGame(l1, depth, "W",0)
    l4 = copy.deepcopy(c)
    # print("l1before",l1)
    ...
    for i in range(len(l4)):
        if l4[i] == 'M':
            l4[i] = 'B'
    # print("MinMax Estimate:",a,"\n","Number of nodes visited",b,"\n","Output board:",l4)
    print("MiniMax Estimate: %s \nPositions evaluated by static estimation:: %s \nBoard Position:: %s " % (a, b, l4))
    sh = "".join(l4)
    print(sh)
